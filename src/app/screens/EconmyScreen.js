...
const EconmyScreen = () => {
  ...
  return isReading ? (
    ...
    <View style={styles.main}>
      ...
      <TouchableOpacity style={styles.btn} onPress={() => handelClick(3)}>
        <Text style={styles.btnText}>المحاضرة الثالثة</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.btn} onPress={() => handelClick(4)}>
        <Text style={styles.btnText}>المحاضرة الرابعة</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.btn} onPress={() => handelClick(5)}>
